...
('2026-02-05',  80,  6.45, '2026-08-05', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0001')),

('2026-01-15', 200,  3.25, '2026-06-15', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0002')),
('2026-02-18', 150,  3.20, '2026-07-18', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0002')),

('2026-01-08',  90,  9.75,  '2027-05-20', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0003')),
('2026-02-12', 110,  9.60,  '2027-07-11', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0003')),

('2026-01-20',  70, 12.50,  '2027-02-21', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0004')),
('2026-02-22',  60, 12.30,  '2027-04-18', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0004')),

('2026-01-25',  50, 18.90, '2027-01-25', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0005')),
('2026-02-20',  40, 18.50, '2027-02-20', (SELECT id_producto FROM productos WHERE codigo_producto='PRD-0005'));
