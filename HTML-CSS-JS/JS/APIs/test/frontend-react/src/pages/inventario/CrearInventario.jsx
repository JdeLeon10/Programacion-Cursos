...
export default function CrearInventario() {
  ...
  async function handleSubmit(e) {
    ...
    if (!payload.codigo_producto || !payload.fecha_ingreso) {
      setResult({ message: 'Código de producto y fecha de ingreso son obligatorios.', isError: true });
      return;
    }
    ...
    <>
      ...
      <main className="content-area">
        <div className="card-panel">
          <h5><span className="method-badge badge-post">POST</span> &nbsp;Nueva Entrada</h5>
