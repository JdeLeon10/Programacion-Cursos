  ...
  return (
    <>
      <header className="page-header">
        ...
        <h1>
          Editar Producto <small className="page-sub-id">#{id}</small>
        </h1>
      </header>
      ...
      <main className="content-area">
        <div className="card-panel">
          <h5>
            <span className="method-badge badge-put">PUT</span> &nbsp;Editar
            Producto
          </h5>

          {loading && (
            <p className="muted-text">Cargando datos del producto…</p>
          )}
